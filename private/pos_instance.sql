...
CREATE TABLE IF NOT EXISTS `empresa` (
  ...
  `cedula` varchar(100) DEFAULT NULL CHARACTER SET armscii8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `orden_de_servicio` (
  ...
  `extra_params` text DEFAULT NULL COMMENT 'Un json con valores extra que se necesitan llenar',
