...
--
-- Table structure for table `compra_proveedor_flete`
--
...
--
-- Table structure for table `compra_sucursal`
--
...
--
-- Table structure for table `detalle_compra_sucursal`
--
...
CREATE TABLE IF NOT EXISTS `detalle_inventario` (
  ...
  `exitencias_procesadas` float NOT NULL,
...
--
-- Table structure for table `inventario_maestro`
--
...
--
-- Constraints for table `compra_proveedor_flete`
--
...
--
-- Constraints for table `compra_sucursal`
--
...
--
-- Constraints for table `detalle_compra_sucursal`
--
...
--
-- Constraints for table `inventario_maestro`
--
