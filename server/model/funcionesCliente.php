<?php
	...
	function actualizarCliente(){
		...
		$cliente = new clienteExistente($_REQUEST['id']); 
	...
	function listarClientes(){
		$listar = new listar("SELECT cliente.id_cliente, rfc, nombre, direccion, telefono, e_mail, limite_credito, descuento, cuenta_cliente.saldo, (SELECT (limite_credito - cuenta_cliente.saldo)) AS credito_restante FROM  `cliente` INNER JOIN  `cuenta_cliente` ON cliente.id_cliente = cuenta_cliente.id_cliente WHERE cliente.id_cliente >1",array());
		echo $listar->lista();
		return $listar->lista();
	}
	...
	function mostrarCliente(){
		...
		$cliente = new clienteExistente($id);
