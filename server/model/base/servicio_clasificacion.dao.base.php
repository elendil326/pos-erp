...
abstract class ServicioClasificacionDAOBase extends DAO
{
		...
		private static function recordExists(  $id_servicio, $id_clasificacion_servicio ){
			$pk = "";
			$pk .= $id_servicio . "-";
			$pk .= $id_clasificacion_servicio . "-";
			return array_key_exists ( $pk , self::$loadedRecords );
		}
		private static function pushRecord( $inventario,  $id_servicio, $id_clasificacion_servicio){
			$pk = "";
			$pk .= $id_servicio . "-";
			$pk .= $id_clasificacion_servicio . "-";
			self::$loadedRecords [$pk] = $inventario;
		}
		private static function getRecord(  $id_servicio, $id_clasificacion_servicio ){
			$pk = "";
			$pk .= $id_servicio . "-";
			$pk .= $id_clasificacion_servicio . "-";
	...
	{
		if(self::recordExists(  $id_servicio, $id_clasificacion_servicio)){
			return self::getRecord( $id_servicio, $id_clasificacion_servicio );
		}
		...
		if(count($rs)==0)return NULL;
			...
			self::pushRecord( $foo,  $id_servicio, $id_clasificacion_servicio );
			return $foo;
	}
	...
	public static final function getAll( $pagina = NULL, $columnas_por_pagina = NULL, $orden = NULL, $tipo_de_orden = 'ASC' )
	{
		...
		foreach ($rs as $foo) {
    		...
    		self::pushRecord( $bar, $foo["id_servicio"],$foo["id_clasificacion_servicio"] );
		}
		return $allData;
	}
