...
class Cliente extends VO
{
	...
	{ 
		if(isset($data))
		{
			...
			if( isset($data['numero_exteriror']) ){
				$this->numero_exteriror = $data['numero_exteriror'];
			}
	...
	{ 
		$vec = array( 
			...
			"calle" => $this->calle,
			"numero_exteriror" => $this->numero_exteriror,
	...
	/**
	  * getNumeroExteriror
	  * 
	  * Get the <i>numero_exteriror</i> property for this object. Donde <i>numero_exteriror</i> es numero exteriror del domicilio fiscal del cliente
	  * @return varchar(10)
	  */
	final public function getNumeroExteriror()
	{
		return $this->numero_exteriror;
	}

	/**
	  * setNumeroExteriror( $numero_exteriror )
	  * 
	  * Set the <i>numero_exteriror</i> property for this object. Donde <i>numero_exteriror</i> es numero exteriror del domicilio fiscal del cliente.
	  * Una validacion basica se hara aqui para comprobar que <i>numero_exteriror</i> es de tipo <i>varchar(10)</i>. 
	  * Si esta validacion falla, se arrojara... algo. 
	  * @param varchar(10)
	  */
	final public function setNumeroExteriror( $numero_exteriror )
	{
		$this->numero_exteriror = $numero_exteriror;
	}
