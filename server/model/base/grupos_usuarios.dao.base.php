<?php
/* GruposUsuarios Data Access Object (DAO).
 * Esta clase contiene toda la manipulación de bases de datos que se necesita para 
 * almacenar de forma permanente y recuperar instancias de objetos GruposUsuarios. 
 */

class GruposUsuariosDAOBase
{
	...
	/**
	  *	Este método guarda el estado actual de objeto GruposUsuarios en la base de datos. La llave 
	  *	primaria indicará qué instancia va a ser actualizado en base de datos. Si la llave primara 
	  *	no esta definicda en el objeto, entonces save() creara una nueva fila.
	  **/
	final public function save( &$grupos_usuarios )
	{
	...
	/**
	  ...
	  **/
	final public function getByPK(  $id_grupo, $id_usuario )
	{
	...
	/**
	  ...
	  * un vector que contiene objetos de tipo GruposUsuarios. Tenga en cuenta que este método
	 ...
	 */
	final public function search( $grupos_usuarios )
	{
	...
	/**
	  ...
	  **/
	final public function update( $grupos_usuarios )
	{
	}
	...
	/**
	  ...
	  * contenidos del objeto GruposUsuarios suministrado. Asegúrese
	  ...
	  **/
	final public function create( &$grupos_usuarios )
	{
	...
	/**
	  ...
	  **/
	final public function delete( &$grupos_usuarios )
	{
	}
