 ...
 * almacenar de forma permanente y recuperar instancias de objetos FacturaVenta. 
 */

class FacturaVentaDAOBase
{
	...
	/**
	  *	Este método guarda el estado actual de objeto FacturaVenta en la base de datos. La llave 
	  *	primaria indicará qué instancia va a ser actualizado en base de datos. Si la llave primara 
	  *	no esta definicda en el objeto, entonces save() creara una nueva fila.
	  **/
	final public function save( &$factura_venta )
	{
	...
	/**
	  ...
	  * un vector que contiene objetos de tipo FacturaVenta. Tenga en cuenta que este método
	 ...
	 */
	final public function search( $factura_venta )
	{
	...
	/**
	  ...
	  **/
	final public function update( $factura_venta )
	{
	...
	/**
	  ...
	  * contenidos del objeto FacturaVenta suministrado. Asegúrese
	  ...
	  **/
	final public function create( &$factura_venta )
	{
	...
	/**
	  ...
	  **/
	final public function delete( &$factura_venta )
	{
