...
abstract class DocumentoDAOBase extends DAO
{
	...
	public static final function search( $documento , $orderBy = null, $orden = 'ASC')
	{
		...
		if( $documento->getDescripcion() != NULL){
			$sql .= " descripcion = ? AND";
			array_push( $val, $documento->getDescripcion() );
		}
	...
	private static final function create( &$documento )
	{
		...
		if($ar == 0) return 0;
		 $documento->setIdDocumento( $conn->Insert_ID() );
		return $ar;
	}
	...
	public static final function byRange( $documentoA , $documentoB , $orderBy = null, $orden = 'ASC')
	{
		...
		if( (($a = $documentoA->getIdentificador()) != NULL) & ( ($b = $documentoB->getIdentificador()) != NULL) ){
		...
		if( (($a = $documentoA->getDescripcion()) != NULL) & ( ($b = $documentoB->getDescripcion()) != NULL) ){
