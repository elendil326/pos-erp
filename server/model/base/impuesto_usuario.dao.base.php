...
abstract class ImpuestoUsuarioDAOBase extends DAO
{
	...
	{
		if( ! is_null ( self::getByPK(  $impuesto_usuario->getIdImpuesto() , $impuesto_usuario->getIdUsuario() ) ) )
		{
	...
	{
		if( is_null( self::getByPK($impuesto_usuario->getIdImpuesto(), $impuesto_usuario->getIdUsuario()) ) ) throw new Exception('Campo no encontrado.');
