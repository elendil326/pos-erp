...
class PosConfig extends VO
{
	...
	/**
	  ...
	  * Una validacion basica se hara aqui para comprobar que <i>opcion</i> es de tipo <i>varchar(8)</i>. 
	...
	/**
	  ...
	  * Una validacion basica se hara aqui para comprobar que <i>value</i> es de tipo <i>varchar(32)</i>. 
	  * Si esta validacion falla, se arrojara... algo. 
	  * @param varchar(32)
	  */
