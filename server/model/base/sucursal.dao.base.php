<?php
/* Sucursal Data Access Object (DAO).
 * Esta clase contiene toda la manipulación de bases de datos que se necesita para 
 * almacenar de forma permanente y recuperar instancias de objetos Sucursal. 
 */

class SucursalDAOBase
{
	...
	/**
	  *	Este método guarda el estado actual de objeto Sucursal en la base de datos. La llave 
	  *	primaria indicará qué instancia va a ser actualizado en base de datos. Si la llave primara 
	  *	no esta definicda en el objeto, entonces save() creara una nueva fila.
	  **/
	final public function save( &$sucursal )
	{
	...
	/**
	  ...
	  **/
	final public function getByPK(  $id_sucursal )
	{
	...
	/**
	  ...
	  * un vector que contiene objetos de tipo Sucursal. Tenga en cuenta que este método
	 ...
	 */
	final public function search( $sucursal )
	{
	...
	/**
	  ...
	  **/
	final public function update( $sucursal )
	{
	...
	/**
	  ...
	  * contenidos del objeto Sucursal suministrado. Asegúrese
	  ...
	  **/
	final public function create( &$sucursal )
	{
	...
	/**
	  ...
	  **/
	final public function delete( &$sucursal )
	{
