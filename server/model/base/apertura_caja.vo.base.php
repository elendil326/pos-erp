...
class AperturaCaja extends VO
{
	...
	/**
	  * id_cajero
	  * 
	  * Id del usuario que realizar‡ las funciones de cajero<br>
	  * @access public
	  * @var int(11)
	  */
	public $id_cajero;
	...
	/**
	  * getIdCajero
	  * 
	  * Get the <i>id_cajero</i> property for this object. Donde <i>id_cajero</i> es Id del usuario que realizar‡ las funciones de cajero
	  * @return int(11)
	  */
	...
	/**
	  ...
	  * 
	  * Set the <i>id_cajero</i> property for this object. Donde <i>id_cajero</i> es Id del usuario que realizar‡ las funciones de cajero.
