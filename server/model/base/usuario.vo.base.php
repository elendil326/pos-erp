...
class Usuario extends VO
{
	...
	/**
	  * id_rol
	  * 
	  * Id del rol que desempeÃƒÆ’Ã‚Â±ara el usuario en la instancia<br>
	  * @access public
	  * @var int(11)
	  */
	public $id_rol;
	...
	/**
	  * mensajeria
	  * 
	  * Si el cliente cuenta con una cuenta de mensajerÃƒÆ’Ã‚Â­a y paqueterÃƒÆ’Ã‚Â­a<br>
	  * @access public
	  * @var tinyint(1)
	  */
	public $mensajeria;
	...
	/**
	  ...
	  * 
	  * DenominaciÃƒÆ’Ã‚Â³n comercial del cliente<br>
	  * @access public
	  * @var varchar(100)
	  */
	...
	/**
	  * dias_de_credito
	  * 
	  * DÃƒÆ’Ã‚Â­as de crÃƒÆ’Ã‚Â©dito que se le darÃƒÆ’Ã‚Â¡n al cliente<br>
	  * @access public
	  * @var int(11)
	  */
	...
	/**
	  * dia_de_revision
	  * 
	  * Fecha de revisiÃƒÆ’Ã‚Â³n del cliente<br>
	  * @access public
	  * @var int(11)
	  */
	...
	/**
	  * tiempo_entrega
	  * 
	  * Tiempo de entrega del proveedor en dÃƒÆ’Ã‚Â­as<br>
	  * @access public
	  * @var int(11)
	  */
	...
	/**
	  * getIdRol
	  * 
	  * Get the <i>id_rol</i> property for this object. Donde <i>id_rol</i> es Id del rol que desempeÃƒÆ’Ã‚Â±ara el usuario en la instancia
	  * @return int(11)
	  */
	...
	/**
	  * setIdRol( $id_rol )
	  * 
	  * Set the <i>id_rol</i> property for this object. Donde <i>id_rol</i> es Id del rol que desempeÃƒÆ’Ã‚Â±ara el usuario en la instancia.
	...
	/**
	  * getMensajeria
	  * 
	  * Get the <i>mensajeria</i> property for this object. Donde <i>mensajeria</i> es Si el cliente cuenta con una cuenta de mensajerÃƒÆ’Ã‚Â­a y paqueterÃƒÆ’Ã‚Â­a
	  * @return tinyint(1)
	  */
	...
	/**
	  ...
	  * 
	  * Set the <i>mensajeria</i> property for this object. Donde <i>mensajeria</i> es Si el cliente cuenta con una cuenta de mensajerÃƒÆ’Ã‚Â­a y paqueterÃƒÆ’Ã‚Â­a.
	...
	/**
	  ...
	  * 
	  * Get the <i>denominacion_comercial</i> property for this object. Donde <i>denominacion_comercial</i> es DenominaciÃƒÆ’Ã‚Â³n comercial del cliente
	  * @return varchar(100)
	  */
	...
	/**
	  ...
	  * 
	  * Set the <i>denominacion_comercial</i> property for this object. Donde <i>denominacion_comercial</i> es DenominaciÃƒÆ’Ã‚Â³n comercial del cliente.
	...
	/**
	  * getDiasDeCredito
	  * 
	  * Get the <i>dias_de_credito</i> property for this object. Donde <i>dias_de_credito</i> es DÃƒÆ’Ã‚Â­as de crÃƒÆ’Ã‚Â©dito que se le darÃƒÆ’Ã‚Â¡n al cliente
	  * @return int(11)
	  */
	...
	/**
	  ...
	  * 
	  * Set the <i>dias_de_credito</i> property for this object. Donde <i>dias_de_credito</i> es DÃƒÆ’Ã‚Â­as de crÃƒÆ’Ã‚Â©dito que se le darÃƒÆ’Ã‚Â¡n al cliente.
	...
	/**
	  * getDiaDeRevision
	  * 
	  * Get the <i>dia_de_revision</i> property for this object. Donde <i>dia_de_revision</i> es Fecha de revisiÃƒÆ’Ã‚Â³n del cliente
	  * @return int(11)
	  */
	...
	/**
	  ...
	  * 
	  * Set the <i>dia_de_revision</i> property for this object. Donde <i>dia_de_revision</i> es Fecha de revisiÃƒÆ’Ã‚Â³n del cliente.
	...
	/**
	  * getTiempoEntrega
	  * 
	  * Get the <i>tiempo_entrega</i> property for this object. Donde <i>tiempo_entrega</i> es Tiempo de entrega del proveedor en dÃƒÆ’Ã‚Â­as
	  * @return int(11)
	  */
	...
	/**
	  ...
	  * 
	  * Set the <i>tiempo_entrega</i> property for this object. Donde <i>tiempo_entrega</i> es Tiempo de entrega del proveedor en dÃƒÆ’Ã‚Â­as.
