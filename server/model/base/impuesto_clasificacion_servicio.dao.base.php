...
abstract class ImpuestoClasificacionServicioDAOBase extends DAO
{
		...
		private static function recordExists(  $id_impuesto, $id_clasificacion_servicio ){
			$pk = "";
			$pk .= $id_impuesto . "-";
			$pk .= $id_clasificacion_servicio . "-";
			return array_key_exists ( $pk , self::$loadedRecords );
		}
		private static function pushRecord( $inventario,  $id_impuesto, $id_clasificacion_servicio){
			$pk = "";
			$pk .= $id_impuesto . "-";
			$pk .= $id_clasificacion_servicio . "-";
			self::$loadedRecords [$pk] = $inventario;
		}
		private static function getRecord(  $id_impuesto, $id_clasificacion_servicio ){
			$pk = "";
			$pk .= $id_impuesto . "-";
			$pk .= $id_clasificacion_servicio . "-";
	...
	{
		if(self::recordExists(  $id_impuesto, $id_clasificacion_servicio)){
			return self::getRecord( $id_impuesto, $id_clasificacion_servicio );
		}
		...
		if(count($rs)==0)return NULL;
			...
			self::pushRecord( $foo,  $id_impuesto, $id_clasificacion_servicio );
			return $foo;
	}
	...
	public static final function getAll( $pagina = NULL, $columnas_por_pagina = NULL, $orden = NULL, $tipo_de_orden = 'ASC' )
	{
		...
		foreach ($rs as $foo) {
    		...
    		self::pushRecord( $bar, $foo["id_impuesto"],$foo["id_clasificacion_servicio"] );
		}
		return $allData;
	}
