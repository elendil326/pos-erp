<?php
/* FacturaCompra Data Access Object (DAO).
 * Esta clase contiene toda la manipulación de bases de datos que se necesita para 
 * almacenar de forma permanente y recuperar instancias de objetos FacturaCompra. 
 */

class FacturaCompraDAOBase
{
	...
	/**
	  *	Este método guarda el estado actual de objeto FacturaCompra en la base de datos. La llave 
	  *	primaria indicará qué instancia va a ser actualizado en base de datos. Si la llave primara 
	  *	no esta definicda en el objeto, entonces save() creara una nueva fila.
	  **/
	final public function save( &$factura_compra )
	{
	...
	/**
	  ...
	  **/
	final public function getByPK(  $folio )
	{
	...
	/**
	  ...
	  * un vector que contiene objetos de tipo FacturaCompra. Tenga en cuenta que este método
	 ...
	 */
	final public function search( $factura_compra )
	{
	...
	/**
	  ...
	  **/
	final public function update( $factura_compra )
	{
	...
	/**
	  ...
	  * contenidos del objeto FacturaCompra suministrado. Asegúrese
	  ...
	  **/
	final public function create( &$factura_compra )
	{
	...
	/**
	  ...
	  **/
	final public function delete( &$factura_compra )
	{
