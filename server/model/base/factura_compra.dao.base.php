...
abstract class FacturaCompraDAOBase extends TablaDAO
{
	...
	/**
	  ...
	  **/
	public static final function search( $factura_compra , $json = false)
	{
	...
	/**
	  ...
	  * @param bool [$json] Verdadero para obtener los resultados en forma JSON y no objetos. En caso de no presentare este parametro se tomara el valor default de false.
	  **/
	public static final function byRange( $factura_compraA , $factura_compraB , $json = false)
	{
		$sql = "SELECT * from factura_compra WHERE ("; 
		$val = array();
