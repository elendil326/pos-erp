<?php
/** Value Object file for table unidad_convertible.
  * 
...
class UnidadConvertible extends VO
{
	/**
	  * Constructor de UnidadConvertible
	  * 
	  * Para construir un objeto de tipo UnidadConvertible debera llamarse a el constructor 
	  * sin parametros. Es posible, construir un objeto pasando como parametro un arreglo asociativo 
	  * cuyos campos son iguales a las variables que constituyen a este objeto.
	  * @return UnidadConvertible
	  */
	...
	/**
	  ...
	  * 
	  * Este metodo permite tratar a un objeto UnidadConvertible en forma de cadena.
	...
	/**
	  ...
	  * 
	  * Get the <i>id_unidad_convertible</i> property for this object. Donde <i>id_unidad_convertible</i> es Id de la tabal unidad convertible
	  * @return int(11)
	  */
	...
	/**
	  ...
	  * 
	  * Set the <i>id_unidad_convertible</i> property for this object. Donde <i>id_unidad_convertible</i> es Id de la tabal unidad convertible.
	  ...
	  * No deberias usar setIdUnidadConvertible( ) a menos que sepas exactamente lo que estas haciendo.<br>
