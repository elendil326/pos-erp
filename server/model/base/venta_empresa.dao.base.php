...
abstract class VentaEmpresaDAOBase extends DAO
{
		...
		private static function recordExists(  $id_venta, $id_empresa ){
			$pk = "";
			$pk .= $id_venta . "-";
			$pk .= $id_empresa . "-";
			return array_key_exists ( $pk , self::$loadedRecords );
		}
		private static function pushRecord( $inventario,  $id_venta, $id_empresa){
			$pk = "";
			$pk .= $id_venta . "-";
			$pk .= $id_empresa . "-";
			self::$loadedRecords [$pk] = $inventario;
		}
		private static function getRecord(  $id_venta, $id_empresa ){
			$pk = "";
			$pk .= $id_venta . "-";
			$pk .= $id_empresa . "-";
	...
	{
		if(self::recordExists(  $id_venta, $id_empresa)){
			return self::getRecord( $id_venta, $id_empresa );
		}
		...
		if(count($rs)==0)return NULL;
			...
			self::pushRecord( $foo,  $id_venta, $id_empresa );
			return $foo;
	}
	...
	public static final function getAll( $pagina = NULL, $columnas_por_pagina = NULL, $orden = NULL, $tipo_de_orden = 'ASC' )
	{
		...
		foreach ($rs as $foo) {
			...
			//id_venta
			//id_empresa
    		self::pushRecord( $bar, $foo["id_venta"],$foo["id_empresa"] );
		}
		return $allData;
	}
