...
abstract class DocumentoClienteDAOBase extends DAO
{
	...
	{
		if( ! is_null ( self::getByPK(  $documento_cliente->getIdDocumento() , $documento_cliente->getIdCliente() ) ) )
		{
	...
	{
		if( is_null( self::getByPK($documento_cliente->getIdDocumento(), $documento_cliente->getIdCliente()) ) ) throw new Exception('Campo no encontrado.');
