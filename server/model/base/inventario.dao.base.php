 ...
 * almacenar de forma permanente y recuperar instancias de objetos Inventario. 
 */

class InventarioDAOBase
{
	...
	/**
	  *	Este método guarda el estado actual de objeto Inventario en la base de datos. La llave 
	  *	primaria indicará qué instancia va a ser actualizado en base de datos. Si la llave primara 
	  *	no esta definicda en el objeto, entonces save() creara una nueva fila.
	  **/
	final public function save( &$inventario )
	{
	...
	/**
	  ...
	  * un vector que contiene objetos de tipo Inventario. Tenga en cuenta que este método
	 ...
	 */
	final public function search( $inventario )
	{
	...
	/**
	  ...
	  **/
	final public function update( $inventario )
	{
	...
	/**
	  ...
	  * contenidos del objeto Inventario suministrado. Asegúrese
	  ...
	  **/
	final public function create( &$inventario )
	{
	...
	/**
	  ...
	  **/
	final public function delete( &$inventario )
	{
