...
abstract class ImpuestoSucursalDAOBase extends DAO
{
	...
	{
		if(  self::getByPK(  $impuesto_sucursal->getIdImpuesto() , $impuesto_sucursal->getIdSucursal() ) !== NULL )
		{
	...
	public static final function search( $impuesto_sucursal , $orderBy = null, $orden = 'ASC')
	{
		...
		$val = array();
		if( $impuesto_sucursal->getIdImpuesto() != NULL){
			$sql .= " id_impuesto = ? AND";
			array_push( $val, $impuesto_sucursal->getIdImpuesto() );
		}

		if( $impuesto_sucursal->getIdSucursal() != NULL){
			$sql .= " id_sucursal = ? AND";
	...
	public static final function byRange( $impuesto_sucursalA , $impuesto_sucursalB , $orderBy = null, $orden = 'ASC')
	{
		$sql = "SELECT * from impuesto_sucursal WHERE ("; 
		$val = array();
		if( (($a = $impuesto_sucursalA->getIdImpuesto()) != NULL) & ( ($b = $impuesto_sucursalB->getIdImpuesto()) != NULL) ){
		...
		if( (($a = $impuesto_sucursalA->getIdSucursal()) != NULL) & ( ($b = $impuesto_sucursalB->getIdSucursal()) != NULL) ){
	...
	{
		if(self::getByPK($impuesto_sucursal->getIdImpuesto(), $impuesto_sucursal->getIdSucursal()) === NULL) throw new Exception('Campo no encontrado.');
