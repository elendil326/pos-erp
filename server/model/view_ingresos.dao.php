	...
	static function getDataIngresos( $timeRange, $id_sucursal, $fechaInicio, $fechaFinal )
        {
                ...
                if( $timeRange != null )
                {
                        ...
                        $functionQuery = reportesUtils::selectEfectivoIntervalo($dateInterval, 'ingresos');
                        ...
                        $qry_select = reportesUtils::betweenDatesQueryPart($dateInterval, 'ingresos');
                        ...
                        if ( $qry_select != false )
                        {                       
                                return ViewIngresosDAO::getResultArray( $completeQuery, $params );
