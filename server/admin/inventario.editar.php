...
if (isset($_REQUEST['editar'])) {
    ...
    foreach ($inventariosSucursales as $i) {
        $i->setPrecioVenta($na->getPrecioVenta());
        $i->setPrecioVentaProcesado($na->getPrecioVentaProcesado());
        ...
        <tr><td>Agrupacion</td>
            <td>
                <select id="agrupacion" name="agrupacion" onChange="agrupacionSeleccionada(this.value)">
                    <option value='null' 		<?php if ($producto->getAgrupacion() == null)
                    echo "selected"; ?>>Sin agrupacion</option>
                    <option value='arpilla'		<?php if ($producto->getAgrupacion() == "arpilla")
                    echo "selected"; ?>>Arpillas</option>
                    <option value='bulto'		<?php if ($producto->getAgrupacion() == "bulto")
                    echo "selected"; ?>>Bultos</option>
                    <option value='costal'		<?php if ($producto->getAgrupacion() == "costal")
                    echo "selected"; ?>>Costales</option>
                    <option value='caja'		<?php if ($producto->getAgrupacion() == "caja")
                    echo "selected"; ?>>Cajas</option>
                </select>
            </td>
