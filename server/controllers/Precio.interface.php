  ...
  **/
  ...
  interface IPrecio {
	...
	/**
 	 ...
 	 **/
  function Editar_precio_rolProducto
	(
	...
	/**
 	 ...
 	 **/
  function Editar_precio_tipo_clienteProducto
	(
		$productos_precios_utlidad, 
	...
	/**
 	 ...
 	 **/
  function Editar_precio_usuarioProducto
	(
		$id_cliente, 
	...
	/**
 	 ...
 	 **/
  function Eliminar_precio_rolProducto
	(
		$id_rol, 
		$productos
	);  
	...
	/**
 	 ...
 	 * @param productos json Arreglo de ids de productos a los que se les quitara el precio preferencial
 	 **/
  function Eliminar_precio_tipo_clienteProducto
	(
		$id_tipo_cliente, 
		$productos
	);  
	...
	/**
 	 ...
 	 * @param productos json Arreglo de ids de productos a los que se les quitara el precio preferencial
 	 **/
  function Eliminar_precio_usuarioProducto
	(
		$id_usuario, 
		$productos
	);  
	...
	/**
 	 ...
 	 * @param productos_precios_utlidad json Arreglo de objetos que contendran un id producto con un precio o margen de utilidad con el que se vendera este producto
 	 **/
  function Nuevo_precio_rolProducto
	(
		$id_rol, 
		$productos_precios_utlidad
	);  
	...
	/**
 	 ...
 	 * @param productos_precios_utilidad json Arreglo de objetos que contendran un id producto con un precio o un margen de utilidad con el que se ofrecera dicho producto
 	 **/
  function Nuevo_precio_tipo_clienteProducto
	(
		$id_tipo_cliente, 
		$productos_precios_utilidad
	);  
	...
	/**
 	 ...
 	 * @param productos_precios_utlidad json Arreglo de objetos que contendran un id producto con un precio o un margen de utilidad con el que se ofrecera dicho producto
 	 **/
  function Nuevo_precio_usuarioProducto
	(
		$id_usuario, 
		$productos_precios_utlidad
	);  
	...
	/**
 	 ...
 	 **/
  function Editar_precio_rolServicio
	(
		$id_rol, 
	...
	/**
 	 ...
 	 **/
  function Editar_precio_tipo_clienteServicio
	(
		$id_tipo_cliente, 
		$servicios_precios_utilidad
	);  
	...
	/**
 	 ...
 	 * @param servicios_precios_utilidad json Arreglo de objetos que contendran un id servicio con un precio o margen de utilidad con el que se vendera este servicio
 	 **/
  function Editar_precio_usuarioServicio
	(
		$id_usuario, 
		$servicios_precios_utilidad
	);  
	...
	/**
 	 ...
 	 **/
  function Eliminar_precio_rolServicio
	(
		$id_rol, 
		$servicios
	);  
	...
	/**
 	 ...
 	 * @param servicios json Arreglo de ids de servicios que perderan el precio preferencial
 	 **/
  function Eliminar_precio_tipo_clienteServicio
	(
		$id_tipo_cliente, 
		$servicios
	);  
	...
	/**
 	 ...
 	 * @param servicios json Arreglo de ids de servicios que perderan el precio preferencial
 	 **/
  function Eliminar_precio_usuarioServicio
	(
		$id_usuario, 
		$servicios
	);  
	...
	/**
 	 ...
 	 * @param servicios_precios_utilidad json Arreglo de objetos que contendran un id servicio con un precio o margen de utilidad con el que se vendera este servicio
 	 **/
  function Nuevo_precio_rolServicio
	(
		$id_rol, 
		$servicios_precios_utilidad
	);  
	...
	/**
 	 ...
 	 * @param servicios_precios_utilidad json Arreglo de objetos que contendran un id servicio con un precio o margen de utilidad con el que se vendera este servicio
 	 **/
  function Nuevo_precio_tipo_clienteServicio
	(
		$id_tipo_cliente, 
		$servicios_precios_utilidad
	);  
	...
	/**
 	 ...
 	 * @param servicios_precios_utilidad json Arreglo de objetos que contendran un id servicio con un precio o margen de utilidad con el que se vendera este servicio
 	 **/
  function Nuevo_precio_usuarioServicio
	(
		$id_usuario, 
		$servicios_precios_utilidad
	);  
