/**
*	@fileoverview	Javascript que contiene funciones para generar tablas de datos usando Flexigrid
*	{@link http://www.flexigrid.info/ } Flexigrid	
*
...
/**
* id de un div generico para agregar el grid a ese, sirve para cuando no se quieren agregar tablas seguidas, sino que se quiere sobreescribir sobre una.
* Se accede estaticamente
*
* @final
* @type String
*/
Datos.gridTable = "tabla-grid-generico";


/**
* Funcion para renderear los elementos de los settings (Introduccion de rango de fechas)
*
*/
...
/**
*
*	loadDataGrid funcion para crear una tabla con datos sin procesar provenientes de la base de datos, usa la libreria jgrid
*	<a href="http://www.trirand.com/jqgridwiki/doku.php?id=wiki:options">jGrid</a>
*
*	@param config {Object} Objeto javascript con la configuracion del del grid
...
*
*	@deprecated Esta funcion usa una libreria que genera un grid no muy agradable, aunque es mas configurable
*
*
*/
...
/**
*	loadDataGrid2 funcion para crear una tabla con datos sin procesar provenientes de la base de datos
*
*	@param config {Objet} Objeto javascript con la configuracion del del grid
*		-> id : identificador del grid
*		-> renderTo : div id valido donde se agregara la tabla
*		-> columns: array con los titulos de las columnas
*		-> data:   datos de las columnas, deben contener los nombres de columans como los identificadores de los valores. 
