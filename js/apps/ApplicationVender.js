...
ApplicationVender.prototype._init = function()
{
    ...
    if(DEBUG){
        console.log("Mostrador: Obteniendo IVA para esta sucursal");
    }
    POS.AJAXandDECODE({
            action: '2104'
        }, 
        ...
        function (e){
            POS.aviso("Error", "Error al obtener el IVA" + e);
            if(DEBUG){
                console.log(e);
            }
        }
...
ApplicationVender.prototype.actualizarDetallesCliente = function ( cliente )
{
    ...
    html += " <div class='ApplicationVender-clienteBox'> ";
        ...
        html +=     "<tr><td style='text-align: right'>Credito restante</td><td>" +  + "</td></tr>";
        html += "</table>";
    html += " </div> ";
