...
<body class="sub">
  <div id="wrapper">
    ...
    <div id="header" class="proveedor" <?php if( POS_STYLE_PROVEEDORES_BANNER ) echo " style='background-image: url(". POS_STYLE_PROVEEDORES_BANNER .")'"; ?>>
      ...
      <div id="header-main">
		<h1 id="MAIN_TITLE">Proveedores</h1> 
      </div>
    </div>
	...
	<?php
	 	if(isset($_GET["action"]) && is_file("../../server/admin/proveedor." . $_GET["action"] . ".php")){
