...
<head>
	...
	<script type="text/javascript" charset="utf-8">jQuery(function(){jQuery("input, select,textarea").uniform();});</script>
...
<body class="sub">
  <div id="wrapper">
    ...
    <div id="header" class="clientes" <?php if( POS_STYLE_CONTABILIDAD_BANNER ) echo " style='background-image: url(". POS_STYLE_CONTABILIDAD_BANNER .")'"; ?> >
      ...
      <div id="header-main">
		<h1 id="MAIN_TITLE">contabilidad</h1> 
      </div>
    </div>
	...
	<?php
	 	if(isset($_GET["action"]) && is_file("../../server/admin/contabilidad." . $_GET["action"] . ".php")){
    		require_once("admin/contabilidad." . $_GET["action"] . ".php");
		}else{
