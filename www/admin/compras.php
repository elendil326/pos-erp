...
<body class="sub">
  <div id="wrapper">
    ...
    <div id="header" class="clientes2" <?php if( POS_STYLE_VENTAS_BANNER ) echo " style='background-image: url(". POS_STYLE_VENTAS_BANNER .")'"; ?>>
	...
	<?php
	 	if(isset($_GET["action"]) && is_file("../../server/admin/compras." . $_GET["action"] . ".php")){
    		require_once("admin/compras." . $_GET["action"] . ".php");
		}else{
