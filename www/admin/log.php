		     ...
		     $.ajax({
		         ...
		         success: function (data) {
		             ...
		             if (response.success === false) {
		                 window.location = "./log.php?success=false&reason=" + response.text;
		                 return;
		             }
