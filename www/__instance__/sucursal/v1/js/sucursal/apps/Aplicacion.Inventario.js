...
{
        name: 'existenciasOriginales', 	
        type: 'float'
    },
{
        name: 'existenciasProcesadas', 	
        type: 'float'
    },
		
{
        name: 'precioIntersucursal',	 	
        type: 'float'
    },
{
        name: 'precioIntersucursalProcesado',	  
        type: 'float'
    }
...
Aplicacion.Inventario.prototype.detalleInventarioPanelCreator = function()
{
    ...
    this.detalleInventarioPanel = new Ext.form.FormPanel({														 
        ...
        items: [{
            ...
            new Ext.form.Text({
                id : 'Aplicacion.Inventario.detalles.existenciasProcesadas', 
                name : 'existenciasProcesadas', 
                label: 'Existencias procesadas'
            }),
            new Ext.form.Text({
                id : 'Aplicacion.Inventario.detalles.existenciasOriginales', 
                name : 'existenciasOriginales', 
                label: 'Existencias originales'
            })
...
Aplicacion.Inventario.ProcesarProducto = function(){
    ...
    this.send = function(){
        ...
        for( var i = 0; i < carritoDeDerivados.length; i++ ){
            ...
            {
                id_producto : carritoDeDerivados[i].data.productoID, 
                procesado : carritoDeDerivados[i].data.cantidad
            }
            );
        }
