...
function conn_info()
{
	...
	<p>
		...
		&nbsp;-&nbsp;
		<a href="<?php echo $_SERVER['PHP_SELF'];?>?execute_sql=1">Execute SQL</a>
		(
		<a href="javascript:void(0)" onclick="popup('<?php echo $_SERVER['PHP_SELF'];?>?execute_sql=1&popup=1')">popup</a>
		)
		&nbsp;-&nbsp;
		...
		&nbsp;-&nbsp;
		<a href="<?php echo $_SERVER['PHP_SELF'];?>?disconnect=1">Disconnect</a>
	</p>
	<?php
}
function size($bytes)
...
<?php if (get('import')): ?>
	...
	<?php layout(); ?>
	<h1><a style="<?php echo $db_name_style;?>" href="<?php echo $_SERVER['PHP_SELF'];?>"><?php echo $db_name_h1?$db_name_h1:$db_name;?></a> &gt; Import</h1>
	<?php conn_info(); ?>
...
<?php layout_start(($db_name_h1?$db_name_h1:$db_name).' &gt; Execute SQL'); ?>
	...
	<?php else: ?>
		<h1><a style="<?php echo $db_name_style;?>" href="<?php echo $_SERVER['PHP_SELF'];?>"><?php echo $db_name_h1?$db_name_h1:$db_name;?></a> &gt; Execute SQL</h1>
	<?php endif; ?>
...
<body>
	...
	<h1><a style="<?php echo $db_name_style;?>" href="<?php echo $_SERVER['PHP_SELF'];?>"><?php echo $db_name_h1?$db_name_h1:$db_name;?></a> &gt; Table: <?php echo $table;?></h1>

	<?php conn_info(); ?>

	<p>
		<a href="<?php echo $_SERVER['PHP_SELF'];?>">All tables</a>
		&nbsp;&gt;&nbsp;
...
<?php layout_start(sprintf('%s &gt; Search', $db_name)); ?>
	<h1><a style="<?php echo $db_name_style;?>" href="<?php echo $_SERVER['PHP_SELF'];?>"><?php echo $db_name_h1?$db_name_h1:$db_name;?></a> &gt; Search</h1>
	<?php conn_info(); ?>
...
<p>
	...
	&nbsp;-&nbsp;
	<a href="<?php echo $_SERVER['PHP_SELF'];?>?searchdb=1&table_filter=<?php echo html_once($get['table_filter']);?>">Search</a>
	&nbsp;-&nbsp;
	<a href="<?php echo $_SERVER['PHP_SELF'];?>?import=1">Import</a>
	&nbsp;-&nbsp;
	Export all:
	&nbsp;
	<a href="<?php echo $_SERVER['PHP_SELF'];?>?dump_all=1&table_filter=<?php echo urlencode(html_once($get['table_filter']));?>">structure</a>
	&nbsp;/&nbsp;
	<a href="<?php echo $_SERVER['PHP_SELF'];?>?dump_all=2&table_filter=<?php echo urlencode(html_once($get['table_filter']));?>">structure & data</a>
...
<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="get" style="margin-bottom: 0.5em;">
<table cellspacing="0" cellpadding="0"><tr>
<td style="padding-right: 3px;">Table name:</td>
<td style="padding-right: 3px;"><input type="text" name="table_filter" value="<?php echo html_once($get['table_filter']);?>"></td>
<td style="padding-right: 3px;"><input type="submit" class="button" wait="1" value="Filter"></td>
</tr></table>
</form>

<?php if ($get['table_filter']): ?>
	<p>Found: <b><?php echo count($tables);?></b></p>
<?php endif; ?>
...
<?php foreach ($tables as $table): ?>
<tr>
	<td><a href="<?php echo $_SERVER['PHP_SELF'];?>?viewtable=<?php echo $table;?>"><?php echo $table;?></a></td>
	<?php
		if ('mysql' == $db_driver) {
			// $table_enq = quote_table($table);
			// $count = db_one("SELECT COUNT(*) FROM $table_enq");
