<?php 
		...
		// 
                if(!$esta_venta->getCancelada())
                {
                    ...
                    $funcion_eliminar = " function eliminar_empresa(btn){".
                            ...
                            "      ".
                            "function confirmar(){".
                            " Ext.MessageBox.confirm('Desactivar', 'Desea cancelar esta venta?', eliminar_empresa );".
                            "}";
		...
		$page->addComponent( $form );
                ...
                {
                    return OrdenDeServicioDAO::getByPK($id_orden_de_servicio) ?
                            ServicioDAO::getByPK(OrdenDeServicioDAO::getByPK($id_orden_de_servicio)->getIdServicio())->getNombreServicio() : "---------";
                }
                ...
                $tabla = new TableComponent(
                        array(
                         ...
                         VentaArpillaDAO::search( new VentaArpilla( array( "id_venta" => $_GET["vid"] ) ) )
                        );
