...
public class Producto {
    ...
    float precioVenta = 0;
    float precio = 0;
    float precio_procesada = 0;
    int id = 0;
    float cantidad = 0;
    float cantidad_procesada = 0;
    float subTotal = 0;
...
//para la descripcion del producto
...
//para la descripcion del producto
                    this.tratamiento = entry.getValue().toString();
                    System.out.println("this.tratamiento: " + this.tratamiento  );
                ...
                if( entry.getKey().toString().equals("precio") ){
                    ...
                    this.precio = Float.parseFloat( entry.getValue().toString() );
