...
public class Main extends Applet {
    ...
    public void start() {
        ...
        //venta a contado
        //String json_dec="{\"tipo_venta\":\"contado\",\"items\":[{\"descripcion\":\"PAPA PRIMERA ORIGINAL\",\"existencias\":\"2847\",\"existenciasMinimas\":\"100\",\"precioVenta\":\"7.5\",\"productoID\":1,\"medida\":\"fraccion\",\"precioIntersucursal\":\"7.5\",\"cantidad\":1},{\"descripcion\":\"PAPA PRIMERA PROCESADA\",\"existencias\":\"2847\",\"existenciasMinimas\":\"100\",\"precioVenta\":\"7.5\",\"productoID\":1,\"medida\":\"fraccion\",\"precioIntersucursal\":\"7.5\",\"cantidad\":1}],\"cliente\":null,\"factura\":false,\"subtotal\":7.5,\"total\":7.5,\"pagado\":\"10\",\"id_venta\":998,\"empleado\":\"RAUL ALEJANDRO LEMUS FLORES\",\"sucursal\":{\"id_sucursal\":\"1\",\"gerente\":\"11\",\"descripcion\":\"PAPAS SUPREMAS 1\",\"direccion\":\"MERCADO DE ABASTOS    BODEGA 49, CELAYA,GUANAJUATO\",\"rfc\":\"GATJ740714F48\",\"telefono\":\"014616128194\",\"token\":null,\"letras_factura\":\"A\",\"activo\":\"1\",\"fecha_apertura\":\"2010-12-30 22:12:02\",\"saldo_a_favor\":\"0\"},\"ticket\":true}";
        //venta a credito
        ...
        //abono_venta
        //String json_dec="{    \"abono_venta\": true,\"empleado\": \"RAUL ALEJANDRO LEMUS FLORES\",    \"id_venta\": 1,    \"concepto_prestamo\": \"asdasdasdas dasdasdasd\",    \"saldo_prestamo\": 123,    \"monto_abono\": 54,    \"sucursal_origen\": {        \"descripcion\": \"PAPAS SUPREMAS 3\",        \"direccion\": \"CENTRAL DE ABASTOS ANDEN E BODEGA 43  APASEO EL GRANDE GUANAJUATO\",        \"rfc\": \"GATJ740714F48\",        \"telefono\": \"014616172030\"     },    \"sucursal_destino\": {        \"descripcion\": \"PAPAS SUPREMAS 3\",        \"direccion\": \"CENTRAL DE ABASTOS ANDEN E BODEGA 43  APASEO EL GRANDE GUANAJUATO\",        \"rfc\": \"GATJ740714F48\",        \"telefono\": \"014616172030\"     }}";
        //genera prestamo
        //String json_dec="{    \"ticket_prestamo\": true,    \"empleado\": \"RAUL ALEJANDRO LEMUS FLORES\",    \"id_prestamo\": 1,    \"concepto_prestamo\": \"asdasdasdas dasdasdasd\",    \"saldo_prestamo\": 123,    \"monto_abono\": 54,    \"sucursal_origen\": {        \"descripcion\": \"PAPAS SUPREMAS 3\",        \"direccion\": \"CENTRAL DE ABASTOS ANDEN E BODEGA 43 APASEO EL GRANDE GUANAJUATO\",        \"rfc\": \"GATJ740714F48\",        \"telefono\": \"014616172030\"     },    \"sucursal_destino\": {        \"descripcion\": \"PAPAS SUPREMAS 3\",        \"direccion\": \"CENTRAL DE ABASTOS ANDEN E BODEGA 43 APASEO EL GRANDE GUANAJUATO\",        \"rfc\": \"GATJ740714F48\",        \"telefono\": \"014616172030\"     }}";
        //surtir sucursal
        //String json_dec="{    \"ticket_surtir\": true,    \"empleado\": \"adasdasdasd fsfsdfsdf\",    \"productos\": [        {            \"id_producto\": 2,            \"descripcion\": \"papas primeras\",            \"procesado\": false,            \"cantidad_procesada\": 0,            \"precio_procesada\": 0,            \"cantidad\": 200,            \"precio\": 10.5         },        {            \"id_producto\": 2,            \"descripcion\": \"papas primeras\",            \"procesado\": false,            \"cantidad_procesada\": 0,            \"precio_procesada\": 0,            \"cantidad\": 200,            \"precio\": 10.5         }     ],    \"sucursal\": {        \"descripcion\": \"PAPAS SUPREMAS 3\",        \"direccion\": \"CENTRAL DE ABASTOS ANDEN E BODEGA 43  APASEO EL GRANDE GUANAJUATO\",        \"rfc\": \"GATJ740714F48\",        \"telefono\": \"014616172030\"     }}";
        //
        ...
        try {
            ...
            if (venta.abono_venta) {
                impresora.imprimirTicket(venta);
            }
            if (venta.abono_prestamo) {
                impresora.imprimirTicket(venta);
            }
            if (venta.ticket_prestamo) {
                impresora.imprimirTicket(venta);
            }
