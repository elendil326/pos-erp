...
public class Venta {
    ...
    /**
     * Guarda una copia del json en bruto
     * que contiene toda la informacion llegada
     * desde donde se invoco la impresion.
     */
    String json = null;
     ...
     * enum(efectivo, cheque o targeta)
     */
    String tipo_pago = null;


    /**
     * Bandera donse se indica si se requiere
     * una factura
     */
    ...
    //leyenda
    static String leyendaPagare = "DEBE(MOS) Y PAGARE(MOS) INCONDICIONALMENTE  A LA ORDEN DE JUAN ANTONIO GARCIA TAPIA LA CANTIDAD TOTAL ARRIBA ESPECIFICADA, VALOR DE LAS MERCANCIAS DETALLADAS Y RECIBIDAS A MI(NUESTRA)ENTERA SATISFACCION.";
    //advertencia fiscal
