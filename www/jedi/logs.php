<?php
	...
	require_once("../../server/jedi/bootstrap.php");
 	...
 	if(isset($_GET["action"]) && is_file("../../server/jedi/logs." . $_GET["action"] . ".php") && ( $_GET['action'] == "descargar" )){
		require_once("jedi/logs." . $_GET["action"] . ".php");
		die();
	}
...
<body class="sub">
  <div id="wrapper">
	...
	<?php
	 	if(isset($_GET["action"]) && is_file("../../server/jedi/logs." . $_GET["action"] . ".php")){
    		require_once("jedi/logs." . $_GET["action"] . ".php");
		}else{
