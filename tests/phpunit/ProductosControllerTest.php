	...
	public function testEditarProducto() {
		...
		public function testBuscarProductosPorID_Sucursal(){
			...
			$this->assertGreaterThan(
				0,
				$res['numero_de_resultados'],
				"---- 'testBuscarProductosPorID_Sucursal' SE DEBIÓ DE ENCONTRAR ALMENOS 1 RESULTADO CON NOMBRE PRODUCTO: ".$nombre_p
			);
		}
		...
		*/
		...
		public function testBuscarCategoriaPorQuery(){
			...
			$this->assertGreaterThanOrEqual(
				1,
				count($res['categorias']),
				"---- 'testBuscarProductosPorID_Categoria' SE DEBIÓ DE ENCONTRAR ALMENOS 1 RESULTADO CON nombre = ".$nombre_cat
			);
		}
